...
class SplitterModel(object):
    ...
    def __init__(self, batch_size, optimizer):
        ...
        self.input_img0 = Input(shape=(self.img_H * self.img_W,))
        self.input_img1 = Input(shape=(self.img_H * self.img_W,))
        
        self.input_labels = Input(shape=(2,))
        self.input_gasdet = Input(shape=(1,))
